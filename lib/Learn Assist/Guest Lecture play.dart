...
class GuestLecturePlay extends StatefulWidget {
  int index1;
  GuestLecturePlay({Key? key, required this.index1}) : super(key: key);

  @override
  State<GuestLecturePlay> createState() => _GuestLecturePlayState();
}

class _GuestLecturePlayState extends State<GuestLecturePlay> {
