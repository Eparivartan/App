...
class EngineeringBasicsDec extends StatefulWidget {
  final String title;
  ...
  @override
  State<EngineeringBasicsDec> createState() => _EngineeringBasicsDecState();
}

class _EngineeringBasicsDecState extends State<EngineeringBasicsDec>
  ...
  String? userId;
  var jsonData;
  List<MyActivityModel> trainingVideosList = [];
  var rootData;
  ...
  Future GetCallDetails() async {
    ...
    if (response.statusCode == 200) {
      jsonData = jsonDecode(response.body)["appliedjobs"];
      setState(() {
      ...
      debugPrint("GETCALL==> Details :: ++ ${(jsonData[1]["favPath"])}");
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      /*appBar: PreferredSize(
        ...
        child: App_Bar_widget(title: 'Engineering Basics'),
      ),*/
