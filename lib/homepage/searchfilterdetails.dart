...
class SearchFilterViewDetails extends StatefulWidget {
  final id;
  const SearchFilterViewDetails({super.key,required,this.id});

  @override
  State<SearchFilterViewDetails> createState() => _SearchFilterViewDetailsState();
}

class _SearchFilterViewDetailsState extends State<SearchFilterViewDetails> {
   String? img;
  bool isLoading = true;
  String? errorMessage;
